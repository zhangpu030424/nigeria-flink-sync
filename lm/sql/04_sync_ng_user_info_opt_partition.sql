-- user_info Flink 多表 Join（分区读版）：大表 JDBC 按 id 分片并行扫，仍全量聚合
-- 全量/大库: FLINK_PARALLELISM=8 LM_MIGRATION_ID_UPPER=500000000 bash lm/scripts/run-ng-user-info-opt-partition.sh
...
CREATE TABLE src_mkt_user (
    ...
    'scan.partition.upper-bound' = '${LM_MIGRATION_ID_UPPER}',
