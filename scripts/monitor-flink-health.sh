...
# 101 用 SOURCE_MYSQL_*；165 老贷超用 MARKET_MYSQL_*（可回退 CORE）
SOURCE_MYSQL_HOST="${SOURCE_MYSQL_HOST:-${MARKET_MYSQL_HOST:-${CORE_MYSQL_HOST:-}}}"
SOURCE_MYSQL_PORT="${SOURCE_MYSQL_PORT:-${MARKET_MYSQL_PORT:-${CORE_MYSQL_PORT:-3306}}}"
SOURCE_MYSQL_USER="${SOURCE_MYSQL_USER:-${MARKET_MYSQL_USER:-${CORE_MYSQL_USER:-}}}"
SOURCE_MYSQL_PASSWORD="${SOURCE_MYSQL_PASSWORD:-${MARKET_MYSQL_PASSWORD:-${CORE_MYSQL_PASSWORD:-}}}"
SOURCE_MYSQL_DATABASE="${SOURCE_MYSQL_DATABASE:-${MARKET_MYSQL_DATABASE:-${CORE_MYSQL_DATABASE:-}}}"
LOG_DIR="logs"
