...
if [[ "$SQL_FILE" == *user_info_latest100* || "$SQL_FILE" == *user_info_bulk* || "$SQL_FILE" == *user_info_direct* || "$SQL_FILE" == *gpt_user_info_one* || "$SQL_FILE" == *id_add_user_bulk* ]]; then
