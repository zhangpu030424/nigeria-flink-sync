...
-- ---------- 4. user_product_sync_staging（源表 user_product.amount_max，同 user+product 取最新）----------
...
-- ---------- 7. id_mapping_sync_staging ----------
-- 大 UNION 单独执行，避免与 1-6 同会话超时断连：
--   mysql ... < sql/ddl/id_mapping_sync_staging.sql
...
-- id_mapping_cnt 见 sql/ddl/id_mapping_sync_staging.sql
