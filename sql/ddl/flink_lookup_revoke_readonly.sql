...
SET @views = 'user_bank_default_lookup,user_bvn_lookup,device_ids_latest_lookup,risk_approval_latest_by_order,user_repay_paid_latest_by_order,user_order_installment_overdue,application_user_lookup,user_repay_paid_by_order_period,user_order_loan_lookup,application_order_lookup,user_order_installment_loan_lookup,vt_token_cache_lookup,user_personal_latest_lookup,app_config_lookup,user_work_latest_lookup,user_credit_latest_lookup,user_reg_ip_lookup,user_emergency_contacts_lookup,user_info_install_source_lookup,user_info_incr_bundle_lookup,users_by_adid_lookup,user_incr_lookup,user_bankcard_id_by_account_lookup,user_bankcard_incr_lookup,user_product_latest_lookup,application_order_id_by_order_no_lookup,application_latest_order_by_user_lookup,application_latest_order_by_device_lookup,application_incr_bundle_lookup';
