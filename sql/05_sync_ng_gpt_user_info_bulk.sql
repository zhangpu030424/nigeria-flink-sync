-- GPT 版 sink_user_info（Flink Batch，读老库 v_flink_* / flink_stg_* 预聚合表）
-- 来源: GPT版本SQL.md — dwd_latest_user_data / password / reg_ip / device_channel + m_app
-- 执行: bash scripts/run-ng-user-info-gpt-bulk.sh
